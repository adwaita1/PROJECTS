...
Assignment Name: Implementation of MiniMax approach for TIC-TAC-TOE using Java/ Scala/ Python-Eclipse Use GUI
...
/*
	Player x will go first and be the letter'X'
		X   | O  | 3
 		    |    |   
 		 ___|____|___ 
